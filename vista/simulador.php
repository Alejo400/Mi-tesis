...
$sql = "INSERT INTO historialaccion VALUES ('','$usuario','$nombre','Entrada a simulador de Objetos Macizos','$tipo','$genero','$hora_actual','$actual')";
$res = mysql_query($sql);
...
title="Añade cada una de las caracteristicas al tanque y al objeto. Asigna las dimensiones y haz click en iniciar para dejar caerlo y ver 
el proceso de flotabilidad. Puedes ver los datos en cada esquina de la pantalla. SELECCIONA CON CUIDADO ya que los botones se bloquean al ser ejecutado.
!Recarga la pagina para iniciar nuevamente el simulador"> <span class="glyphicon glyphicon-question-sign"> </span></button>
