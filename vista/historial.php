...
<input type="reset" value="Limpiar" class="btn btn-danger">
  ...
  <div role="tabpanel">
      ...
      <li role="presentation" class="active"> <a href="#seccion1" aria-controls="seccion1" data-toggle="tab" role="tab"> Historial de sesión</a></li>
      <li role="presentation">                <a href="#seccion2" aria-controls="seccion2" data-toggle="tab" role="tab"> Historial de acción</a></li>
  ...
  <div class="container">
                ...
                $query ="SELECT * FROM historialsesion ORDER BY id_visita DESC"; 
                $res_lista = mysql_query($query); 
                $result = mysqli_query($connect, $query); 
                $listas = mysql_num_rows($res_lista); 
                ...
                <div class="table-responsive">  
                     <table id="employee_data" class="table table-striped table-bordered">  
                          <thead>  
                            <th colspan="7" style="background-color: #428bca; color: #FFFFFF"><h3 align="center">Historial de Sesión</h3>  </th>
                               <tr>  
                                    ...
                                    <td><center><h4>Hora de ingreso al Sistema</h4></center></td>
                                    <td><center><h4>Fecha de ingreso al Sistema</h4></center></td>
                               </tr>  
                          </thead>  
                          <?php  
   ...
   <?php if($listas >= 1) { ?> <a href="sweet/eliminarh.php" class="btn btn-danger btn-lg pull-left">
   <span class="glyphicon glyphicon-trash"></span> Eliminar registros</a> <?php } ?>
                </div>  
 ...
 $(document).ready(function(){  
  ...
  <div class="container">
                ...
                $connect = mysqli_connect("localhost", "root", "", "flotabilidad");  
                mysqli_set_charset($connect,"utf8");
                $query ="SELECT * FROM historialaccion ORDER BY id_accion DESC"; 
                $queryres ="SELECT * FROM historialaccion ORDER BY id_accion DESC"; 
                $res_lista2 = mysql_query($queryres); 
                $result = mysqli_query($connect, $query);  
                $listas2 = mysql_num_rows($res_lista2); 
                ...
                <div class="table-responsive">  
                     <table id="employee_data2" class="table table-striped table-bordered">  
                          <thead>  
                            <th colspan="7" style="background-color: #428bca; color: #FFFFFF"><h3 align="center">Historial de Acción</h3>  </th>
                               <tr>  
                                    <td><center><h4>Usuario</h4></center></td>  
                                    <td><center><h4>Nombre</h4></center></td>  
    ...
    <?php if($listas2 >= 1) { ?> <a href="sweet/eliminarha.php" class="btn btn-danger btn-lg pull-left">
   <span class="glyphicon glyphicon-trash"></span> Eliminar registros</a> <?php } ?>
                </div>  
                ...
                <form class="form-horizontal" action="#">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="glyphicon glyphicon-user" style="color: #36A0FF; font-size: 35px;"></i></span>
                            <div class="col-md-8">
                                <h4> Aleuxis Rausseo <a href="https://www.facebook.com/aleuxis.rauseo" target="__blank">
