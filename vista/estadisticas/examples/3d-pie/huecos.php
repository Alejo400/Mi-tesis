...
$sql_u = "SELECT *FROM historialaccion WHERE tipo = 'usuario' and Actividad like '%Objetos Huecos%'";
$res_u = mysql_query($sql_u);
$row_u = mysql_num_rows($res_u);

//Estadisticas del operador

$sql_o = "SELECT *FROM historialaccion WHERE tipo = 'operador' and Actividad like '%Objetos Huecos%'";
$res_o = mysql_query($sql_o);
$row_o = mysql_num_rows($res_o);

//Estadisticas del administrador

$sql_ad = "SELECT *FROM historialaccion WHERE tipo = 'administrador' and Actividad like '%Objetos Huecos%'";
$res_ad = mysql_query($sql_ad);
$row_ad = mysql_num_rows($res_ad);

//Estadisticas de las Mujeres

$sql_m = "SELECT *FROM historialaccion WHERE sexo = 'Masculino' and Actividad like '%Objetos Huecos%'";
$res_m = mysql_query($sql_m);
$row_m = mysql_num_rows($res_m);

//Estadisticas de los hombres

$sql_h = "SELECT *FROM historialaccion WHERE sexo = 'Femenino' and Actividad like '%Objetos Huecos%'";
