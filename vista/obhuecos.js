...
var madera = "madera2.jpg";

// DOM

var mostrar = 0, imagen = "madera2.jpg", dimension_mostrar = 0;
...
mostrar_v_m = 0, boton, reinicio = 1, distancia, pxcalado, calculo_cubo, agua_peso = 9.81, apagar = 0;
...
select_material.option("Material:"); select_material.option(madera); select_material.option("oro2.jpg"); select_material.option("acero2.jpg");
...
select_espesor.position(windowWidth * 25 / 100,10);
select_espesor.size(windowWidth * 8 / 100);
...
botones.position(windowWidth * 48 / 100,10);
...
select_cilx.position(windowWidth * 34 / 100,10);
...
select_cily.position(windowWidth * 41 / 100,10);
...
select_cux.position(windowWidth * 34 / 100,10);
...
if (imagen == "madera2.jpg"){ densidad = 600; } if (imagen == "oro2.jpg"){ densidad = 19300; } if (imagen == "acero2.jpg"){ densidad = 7800; }
...
//Volumen cubo hueco
volumen_cubo = 6 * area_cubo * espesor;

//Peso del objeto
peso_objeto = pesoes_material * volumen_cubo;

calado = peso_objeto / (area_cubo * pesoes_fluido); //CALCULO DE CALADO
